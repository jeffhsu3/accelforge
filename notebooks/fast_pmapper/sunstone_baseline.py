...
bounds = {"P": 1, "Q": 16*1024, "R": 1, "S": 1, "C": 16*1024, "K": 16*1024, "N": 1}
tens_desc = [[("P", "R"), ("Q", "S"), "C", "N"], ["R", "S", "C", "K"], ["P", "Q", "K", "N"]]
...
with open(DATA_DIR / "sunstone_gemm_16k.csv", 'w') as csvfile:
