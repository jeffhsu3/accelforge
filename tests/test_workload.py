        ...
        self.assertEqual(
            {
                ...
                ('PwiseA0', 'T0'): {('P0', 'p0'): (1, 0), ('Q0', 'q0'): (1, 0), ('N0', 'n0'): (1, 0)},
                ('PwiseA0', 'TA0'): {('P0', 'p0'): (1, 0), ('Q0', 'q0'): (1, 0), ('T0', 't0'): (1, 0)}, ('Dwise0', 'WAB0'): {('R0', 'r0'): (1, 0), ('S0', 's0'): (1, 0), ('T0', 't0'): (1, 0)},
                ('Dwise0', 'TB0'): {('P1', 'p1'): (1, 0), ('Q1', 'q1'): (1, 0), ('T0', 't0'): (1, 0)},
                ('Dwise0', 'TA0'): {('P0', 'r0'): (1, 6), ('P0', 'p1'): (1, 2), ('Q0', 'q1'): (1, 2), ('Q0', 's0'): (1, 6), ('T0', 't0'): (1, 0)},
                ('PwiseB0', 'WB0'): {('T0', 't0'): (1, 0), ('N1', 'n1'): (1, 0)},
                ('PwiseB0', 'T1'): {('P1', 'p1'): (1, 0), ('Q1', 'q1'): (1, 0), ('N1', 'n1'): (1, 0)},
                ('PwiseB0', 'TB0'): {('P1', 'p1'): (1, 0), ('Q1', 'q1'): (1, 0), ('T0', 't0'): (1, 0)},
                ('PwiseA1', 'TA1'): {('P1', 'p1'): (1, 0), ('Q1', 'q1'): (1, 0), ('T1', 't1'): (1, 0)},
                ('PwiseA1', 'T1'): {('P1', 'p1'): (1, 0), ('Q1', 'q1'): (1, 0), ('N1', 'n1'): (1, 0)},
                ('PwiseA1', 'WA1'): {('N1', 'n1'): (1, 0), ('T1', 't1'): (1, 0)},
                ('Dwise1', 'TA1'): {('P1', 'p2'): (1, 2), ('P1', 'r1'): (1, 6), ('Q1', 'q2'): (1, 2), ('Q1', 's1'): (1, 6), ('T1', 't1'): (1, 0)},
                ('Dwise1', 'TB1'): {('P2', 'p2'): (1, 0), ('Q2', 'q2'): (1, 0), ('T1', 't1'): (1, 0)},
                ('Dwise1', 'WAB1'): {('R1', 'r1'): (1, 0), ('S1', 's1'): (1, 0), ('T1', 't1'): (1, 0)},
                ('PwiseB2', 'T2'): {('P2', 'p2'): (1, 0), ('Q2', 'q2'): (1, 0), ('N2', 'n2'): (1, 0)},
                ('PwiseB2', 'WB1'): {('T1', 't1'): (1, 0), ('N2', 'n2'): (1, 0)},
                ('PwiseB2', 'TB1'): {('P2', 'p2'): (1, 0), ('Q2', 'q2'): (1, 0), ('T1', 't1'): (1, 0)}
            },
            initial_deltas
        )